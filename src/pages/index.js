...
const IndexPage = ({ location }) => {
  ...
  return (
    ...
    >
      <SEO title="Academia" />
      <Container>
        <Logo src="https://prosas.com.br/system/empreendedores/avatar_capas/000/024/115/original/perfil_capa_empreendedor_6105d6cc76af400325e94d588ce511be5bfdbb73b437dc51eca43917d7a43e3d.png?1556307548" />
        <Message>
          Olá! Aqui você vai encontrar todo o material de apoio relacionado ao curso Edcuap.
        </Message>
        <ModulesList>
          {renderModules()}
        </ModulesList>
